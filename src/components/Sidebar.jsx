     ...
     <div className='flex items-center py-3 px-2 space-x-4'>
      ...
      <div>
        ...
        <ul className='flex flex-col mt-5 text-xl'>
            <Link to="/" className='flex items-center py-3 px-2 space-x-4 font-normal rounded-xl border-4 text-white  bg-blue-500 border-blue-500 hover:rounded hover:cursor-pointer ' ><img src={assets.Dash} alt="" /> <span className='hidden md:inline'>Dashboard</span></Link>
